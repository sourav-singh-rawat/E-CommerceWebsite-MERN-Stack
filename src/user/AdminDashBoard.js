...
export default function AdminDashBoard() {
    ...
    //destructuring the jwt data (cant access name and email directly by isAuthenticated, need to go into user and destruct..)
    ...
    return (
        <Base title="Welcom to admin area" description="Manage all of your products here" className="container bg-success p-4">
            <div className="row">
